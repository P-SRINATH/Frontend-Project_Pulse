...
const getProjectDetails=async()=>{
      if(userObj.user_role==="GDO"){
        let res=await axios.get(`http://localhost:4000/gdo/getProjectDetails/${userObj.user_email}/${params.project_id}`,{
        ...
        let res=await axios.get(`http://localhost:4000/projectManager/getSpecificProjectDetails/${userObj.user_email}/${params.project_id}`,{
          headers:{Authorization: `Bearer ${token}`}
        })
        if(res.status===200){
          setFitness(res.data.ProjectFitness)
        ...
        let res=await axios.get(`http://localhost:4000/admin/getSpecificProjectDetails/${params.project_id}`,{
          headers:{Authorization: `Bearer ${token}`}
        })
        if(res.status===200){
          setFitness(res.data.ProjectFitness)
    ...
    <div className=" container ">
      <div class="row text-center">
        <div class="col-sm-4">
          <div class="card shadow bg-warning">
            <div class="card-body">
              ...
              <p class="card-text">Shows the Fitness of this project with the organization</p>
        ...
        <div class="col-sm-4">
          <div class="card shadow bg-dark text-light">
            <div class="card-body">
              ...
              <p class="card-text">Number of employess working on this particular Project.</p>
        ...
        <div class="col-sm-4">
          <div class="card shadow bg-warning">
            <div class="card-body">
              ...
              <p class="card-text">Shows the Number of Concerns raised for this Specific Project</p>
        ...
        <tbody>
            ...
            <td><b>Project ID :</b> {proObj.project_id}</td>
            <td><b>GDO :</b> {proObj.gdoemail}</td>
            <td><b>Project Manager :</b> {proObj.project_manager_email}</td>
            <td><b>Project Name : </b>{proObj.project_name}</td>
            </tr>
            <tr>
            <td><b>Project Client :</b> {proObj.project_client}</td>
            <td><b>Client Account :</b> {proObj.client_account}</td>
            <td><b>Client Manager :</b> {proObj.client_account_manager}</td>
            <td><b>Status of Project:</b> {proObj.status_of_project}</td>
            </tr><tr>
            <td><b>Start Date :</b> {proObj.project_start_date}</td>
            <td><b>End Date :</b> {proObj.project_fitness}</td>
            <td><b>Domain of Project :</b> {proObj.domain_of_project}</td>
            <td><b>Type of Project :</b> {proObj.type_of_project}</td>
          </tr>
        </tbody>
    </table>
    <h3 className=" lead fw-bold mt-4 mb-4 text-center"> PROJECT CONCERNS</h3>
    ...
    <table className='table text-center table-bordered shadow'>
        ...
        {team.map((team, index) => (
            <tr key={index}>
              ...
              <td>{team.project_start_date}</td>
              <td>{team.project_end_date}</td>
