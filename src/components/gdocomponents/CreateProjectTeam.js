...
export default function CreateProjectTeam() {
  ...
  const createProjectTeam = async () => {
    ...
    let res = await axios.post(
      "http://localhost:4000/gdo/addProjectTeam",
      userObj,
      {
  ...
  return (
    <div className="mt-4">
      ...
      <div className="container me-2 h-100  text-dark shadow">
        <p className="mt-4">
          Hey GDO, Welcome !!! Create your project team Here!!!
        </p>
      ...
      >
        ...
        <Modal.Body>
          <form className="w-75">
            <div className="mt-1">
              ...
              <input
                type="text"
                {...register("resource_name", { required: true })}
                className="form-control"
              />
              {errors.resource_name?.type === "required" && (
            ...
            <div className="mt-1">
              ...
              <select
                ...
                {...register("role_in_project", { required: true })}
              >
            ...
            <div>
              ...
              {errors.project_status?.type === "required" && (
                <p className="text-danger">Required*</p>
              )}
            </div>
            <div className="mt-1">
            ...
            <div className="mt-2">
              <label htmlFor="project_id">
                Add Resource to Project(Mention Project ID)
              </label>
              <select
                class="form-select"
                aria-label="Default select example"
        ...
        <Modal.Footer>
          <Button
            variant="warning"
            type="submit"
            onClick={handleSubmit(createProjectTeam)}
          >
            Create
          </Button>
        </Modal.Footer>
