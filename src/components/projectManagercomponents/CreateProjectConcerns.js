...
export default function CreateProjectConcerns(props) {
  ...
  const projectConcern = async () => {
    ...
    let res = await axios.post(
      "http://localhost:4000/projectManager/createProjectConcerns",
      userObj,
      {
      ...
      >
          ...
          <form className="w-75">
            ...
            <div className="mt-1">
              ...
              <input
                ...
                className="form-control"
              />
              {errors.concern_raised_by?.type === "required" && (
                <p className="text-danger">Required*</p>
              )}
            </div>
            <div className="mt-1">
              ...
              <input
                ...
                className="form-control"
              />
              {errors.concern_raised_on_date?.type === "required" && (
                <p className="text-danger">Required*</p>
              )}
            </div>
            <div className="mt-1">
              ...
              <select
                ...
                {...register("severity_of_concern", { required: true })}
              >
              ...
              {errors.severity_of_concern?.type === "required" && (
                <p className="text-danger">Required*</p>
              )}
            </div>
            <div className="mt-1">
              <label htmlFor="concern_raised_internal">
                Concern Raised Internally
              </label>
              <select
                class="form-select"
                aria-label="Default select example"
                {...register("concern_raised_internal", { required: true })}
              >
                <option selected disabled>
                  Select
                </option>
              ...
              {errors.concern_raised_internal?.type === "required" && (
                <p className="text-danger">Required*</p>
              )}
            </div>
            <div className="mt-1">
              ...
              <select
                class="form-select"
                aria-label="Default select example"
                {...register("status_of_concern", { required: true })}
              >
                <option selected disabled>
                  Select
                </option>
              ...
              {errors.status_of_concern?.type === "required" && (
                <p className="text-danger">Required*</p>
              )}
            </div>
            <div className="mt-1">
              <label htmlFor="concern_mitigated_on_date">
                Concern Mitigated On
              </label>
              <input
                type="date"
                {...register("concern_mitigated_on_date", { required: true })}
                i
                className="form-control"
              />
              {errors.concern_mitigated_on_date?.type === "required" && (
                <p className="text-danger">Required*</p>
              )}
            </div>
          </form>
        ...
        <Modal.Footer>
          <Button
            variant="warning"
            type="submit"
            onClick={handleSubmit(projectConcern)}
          >
            Create
          </Button>
        </Modal.Footer>
